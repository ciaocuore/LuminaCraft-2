...
images.forEach(image => {
    ...
    imgElement.src = `../images/galeria/${image.src}`; // Ruta relativa corregida
    ...
    descriptionElement.textContent = image.description; // Asigna la descripción de la imagen
    ...
    imageWrapper.appendChild(imgElement); // Agrega la imagen al contenedor
    imageWrapper.appendChild(titleElement); // Agrega el título al contenedor
    imageWrapper.appendChild(descriptionElement); // Agrega la descripción al contenedor

    // Agrega el contenedor de la imagen al contenedor principal de la galería
